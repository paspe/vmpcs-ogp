...
\acrodefplural{API}[APIs]{application program interfaces}
%\acro{APT}{advanced persistent threat}
\acro{CPU}{central processing unit}
\acrodefplural{CPU}[CPUs]{central processing units}
\acro{EPT}{extended page table}
\acrodefplural{EPT}[EPTs]{extended page tables}
\acro{GID}{groupID}
\acro{GMFN}{guest machine frame number}
\acro{GVA}{guest virtual address}
\acro{HAP (1)}{hardware assisted paging}
\acro{HAP (2)}{high assurance process}
\acrodefplural{HAP(2)}[HAPs(2)]{high assurance processes}
\acro{HIDS}{host intrusion detection system}
...
\acro{PT}{page table}
\acrodefplural{PT}[PTs]{page tables}
\acro{PWD}{present working directory}
\acro{SACL}{shadow access control list}
\acrodefplural{SACL}[SACLs]{shadow access control lists}
