...
\par As we see in figure~\ref{fig:root_sacl}, the \ac{SACL} for protecting files from the \codeft{root} user is simpler. Since it is targeted for this specific user, we do not need the entries for the owner or group. Furthermore, the permission bits for group and others are ignored when parsed, since they are meaningless.
