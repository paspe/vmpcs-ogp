...
\item More research must be done to verify whether multi-threaded processes have the same \codeft{CR3} value between threads, or not, and keep track of it, for use in the process identity validation.
