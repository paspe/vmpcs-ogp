...
\item Currently \codeft{ferify} provides logging of important events happening in a \ac{VM}. A notification mechanism to alert the system's administrators of illegal access would improve incident response time. This mechanism could potentially include options of how to handle the maliciously accessed \ac{VM}, like auto-pausing.
