...
\par In this chapter we present the benefits of \codeft{ferify}, and the lessons we leanred during its development. We present some limitations of a security solution that is completely transparent to the guest \ac{VM}, as we encountered them. Finally, we present some ideas for future development of \codeft{ferify}.
